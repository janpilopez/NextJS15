...
$this->title = 'Asistencia Comedor';
$this->params['breadcrumbs'][] = 'Asistencia Comedor';
...
<div class="site-contact">
 ...
 <?php ActiveForm::end(); ?>
  ...
  <div class ="row" >
      <div class="col-md-12">
         <?=  Html::a('Exportar a PDF', ['informeasistenciacomedorpdf','fechaini'=> $fechaini, 'fechafin' => $fechafin, 'area'=> $area, 'departamento'=> $departamento, 'filtro'=> $filtro], ['class'=>'btn btn-xs btn-danger pull-right', "target" => "_blank" ]);?>
      </div>
  </div>
  <br>
 <div class= 'row'>
    <div class= 'col-md-12'>
       <?php  echo $this->render('_tableinformecomedor', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 12px; width: 100%"]);?>
    </div>
</diV>
   <?php endif; ?>
</div>
