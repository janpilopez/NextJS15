...
$this->title = 'Resumen - Horas laboradas';
...
<div class="site-contact">
 ...
 <?php ActiveForm::end(); ?>
  ...
  <div class ="row" >
      <div class="col-md-12">
        <?=  Html::a('Exportar a excel', ['resumenxls','fechaini'=> $fechaini, 'fechafin' => $fechafin, 'area'=> $area, 'departamento'=> $departamento], ['class'=>'btn btn-xs btn-success pull-right', "target" => "_blank" ]);?>
      </div>
  </div>
  <br>
 <div class= 'row'>
    <div class= 'col-md-12'>
        <?php  echo $this->render('_tableresumen', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 12px; width: 100%"]); ?>
    </div>
</div>
   <?php endif; ?>
</div>
