...
$this->title = 'Asistencia Individual Laboral';
$this->params['breadcrumbs'][] = 'Asistencia Individual Laboral';
...
<div class="site-contact">
    ...
    <?php ActiveForm::end(); ?>
      ...
      <?php  if($cedula != ''):?>
        ...
        <div class= 'row'>
           <div class = 'col-md-12'>
               <?=  Html::a('Exportar a PDF', ['asistenciaempleadopdf','cedula'=> $empleado->id_sys_rrhh_cedula, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin], ['class'=>'btn btn-xs btn-danger pull-right', "target" => "_blank" ]);?>
           </div>
        </div>
        <br>
        <div class = 'row'>
           <div class = 'col-md-12'>
                  <?php  echo $this->render('_tableasistemp', ['datos'=> $datos,'empleado'=> $empleado, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin, 'style' => "background-color: white; font-size: 12px; width: 100%"]);?>
            </div>
          </div>
         <?php endif;?>
