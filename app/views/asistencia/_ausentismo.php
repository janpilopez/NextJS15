...
$this->title = 'Resumen Asistencia';
$this->params['breadcrumbs'][] = 'Resumen Asistencia';
            ...
            <div class= 'col-md-3'>
             ...
             <?php echo '<label>Area</label>';
                   echo   Html::DropDownList('area', 'area', 
                       ArrayHelper::map(SysAdmAreas::find()->andFilterWhere(['id_sys_adm_area'=> $area])->andFilterWhere(['estado'=>'A'])->all(), 'id_sys_adm_area', 'area'), ['class'=>'form-control input-sm', 'id'=>'area', 'prompt' => 'Todos',  'options'=>[ $area => ['selected' => true]]])
...
<?php if($datos): ?>
    <div class ="row" >
        <div class="col-md-12">
            <?=  Html::a('Exportar a PDF', ['ausentismopdf','fechaini'=> $fechaini, 'fechafin' => $fechafin, 'area'=> $area, 'departamento'=> $departamento], ['class'=>'btn btn-xs btn-danger pull-right', "target" => "_blank" ]);?>
            <?=  Html::a('Exportar a Excel', ['ausentismoxls','fechaini'=> $fechaini, 'fechafin' => $fechafin, 'area'=> $area, 'departamento'=> $departamento], ['class'=>'btn btn-xs btn-success pull-right', "target" => "_blank" ]);?>
        </div>
    </div>
  <br>
 <div class= 'row'>
    <div class= 'col-md-12'>
       <?php  echo $this->render('_tableausentismo', ['fechaini'=> $fechaini, 'fechafin' => $fechafin, 'area'=> $area, 'departamento'=> $departamento, 'datos'=> $datos, 'style' => "background-color: white; font-size: 12px; width: 100%"]);?>
    </div>
</diV>
   <?php endif; ?>
</div>