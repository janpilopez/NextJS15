...
$reporte  = "Asistencia Laboral";

if($tipo == 'F'):

    $reporte  = "Reporte Ausentismo Laboral";

elseif($tipo == 'P'):

    $reporte  = "Reporte Permiso Laboral";

elseif($tipo == 'V'):

    $reporte  = "Reporte Vacaciones";

elseif($tipo == 'V'):

    $reporte  = "Reporte Ausentismo por agendamiento";
...
?>
 ...
 <div class= "row">
    <div class="col-xs-12">
    <?php  echo $this->render('_tableinforme', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin, 'tipo'=> $tipo,  'style' => "background-color: white; font-size: 7px; width: 100%"]);?>
    </div>
 </div>
