...
$this->title = 'Resumen de Horas Individual';
$this->params['breadcrumbs'][] = 'Resumen de Horas Individual';

$empleado = '';

if($cedula != ''){
    
    $empleado =  SysRrhhEmpleados::find()->where(['id_sys_rrhh_cedula'=> trim($cedula)])
...
<div class="site-contact">
                       ...
                       echo Typeahead::widget([ 
                           ...
                           'dataset' => [
                               [
                                   ...
                                   'remote' => [
                                       'url' =>    Url::to(['consultas/listempleados3']) . '?q=%QUERY',
                                       'wildcard' => '%QUERY'
                                   ],
    ...
    <?php ActiveForm::end(); ?>
      ...
      <?php  if($cedula != ''):?>
        ...
        <div class= 'row'>
           <div class = 'col-md-12'>
               <?=  Html::a('Exportar a Excel', ['asistenciaempleadohorasxls','cedula'=> $empleado->id_sys_rrhh_cedula, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin], ['class'=>'btn btn-xs btn-success pull-right', "target" => "_blank" ]);?>
           </div>
        </div>
        <br>
        <div class = 'row'>
           <div class = 'col-md-12'>
                  <?php  echo $this->render('_tableasistemphoras', ['datos'=> $datos,'empleado'=> $empleado, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin, 'style' => "background-color: white; font-size: 12px; width: 100%"]);?>
            </div>
          </div>
         <?php endif;?>
