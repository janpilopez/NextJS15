...
?>
 ...
 <div class= "row">
    <div class="col-xs-12">
    <?php  echo $this->render('_tableinformecomedor', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 7px; width: 100%"]);?>
    </div>
 </div>
