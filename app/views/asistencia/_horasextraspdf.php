 ...
 <div class= "row">
    <div class="col-xs-12">
      ...
      <?php if($tipo == 'R'):
          ...
          echo  $this->render('_tablehextras', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 7px; width: 100%"]);
      
          elseif($tipo == 'D'):
          
          echo  $this->render('_tablehextrasdetalle', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 7px; width: 100%"]);
