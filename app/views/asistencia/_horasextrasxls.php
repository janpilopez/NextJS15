...
if($tipo =='R'):
  ...
  $reporte  = "Resumen Horas Extras Por Empleados";

elseif($tipo == 'D'):

  $reporte  = "Detalle Horas Extras Por Empleados";
  
else:
  
  $reporte  = "Resumen Horas Extras Por Area y Departamento";
 ...
 <div class= "row">
    <div class="col-xs-12">
      ...
      <?php if($tipo == 'R'):
          ...
          echo  $this->render('_tablehextrasxls', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 7px; width: 100%"]);
      
          elseif($tipo == 'D'):
       
            echo $this->render('_tablehextrasdetallexls', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 12px; width: 100%"]);
           
          else:
    
            echo $this->render('_tablehextrasresumenxls', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin,  'style' => "background-color: white; font-size: 12px; width: 100%"]);
