...
?>
  <div class="row">
		...
		<div class="col-xs-12">
			<h3 class="subtitle text-center" style="text-decoration: underline; margin-top: 0px;"><b>Asistencia Laboral</b></h3>
		</div>
 </div>
 ...
 <div class= "row">
        <div class = 'col-md-12'>
                  <?php  echo $this->render('_tableasistemp', ['datos'=> $datos,'empleado'=> $empleado, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin, 'style' => "background-color: white; font-size: 10px; width: 100%"]);?>
            </div>
 </div>
