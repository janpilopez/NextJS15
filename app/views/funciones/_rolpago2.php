...
<div class="row without-margin">
	<div class="col-xs-12 text-center">
	    <img src="../web/logo/<?= $empresa->ruc?>/<?=$empresa->logo?>" height="39" width="180">
	</div>
	<div class="col-xs-12 text-center">
		<h2>Rol de Pago</h2>
...
<div class="row without-margin">
      <table style="font-size: 11px; width:100%">
         ...
         <tr>
           <td><b>Periodo:</b></td>
		   <td colspan="3" style="text-align: left;" ><?= "HORAS EXTRAS DEL ".date('d', strtotime($rol->fecha_ini_liq))." DE ". strtoupper($meses[date('n', strtotime($rol->fecha_ini_liq))])." AL ".date('d', strtotime($rol->fecha_fin_liq))." DE ".strtoupper($meses[date('n', strtotime($rol->fecha_fin_liq))])?></td>
         </tr>
      </table>
</div>
