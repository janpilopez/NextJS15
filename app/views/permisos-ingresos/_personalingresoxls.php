...
class FilterData {
    ...
    $titulo= "Informe General Ingreso Visitas";
    ...
    $hojita->setCellValue('D2', "Informe visitas desde ".$fechaini." hasta ".$fechafin);
    ...
    $hojita->setCellValue('A4', "Cédula");
    $hojita->getStyle('A4')->getFont()->setSize(12);
    $hojita->getStyle('A4')->getFont()->setBold(true);
    $hojita->getStyle('A4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    
    $hojita->setCellValue('B4', "Nombres");
    $hojita->getStyle('B4')->getFont()->setSize(12);
    $hojita->getStyle('B4')->getFont()->setBold(true);
    $hojita->getStyle('B4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    
    $hojita->setCellValue('C4', "Fecha Ingreso");
    $hojita->getStyle('C4')->getFont()->setSize(12);
    $hojita->getStyle('C4')->getFont()->setBold(true);
    $hojita->getStyle('C4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

    $hojita->setCellValue('D4', "Hora Ingreso");
    $hojita->getStyle('D4')->getFont()->setSize(12);
    $hojita->getStyle('D4')->getFont()->setBold(true);
    $hojita->getStyle('D4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    
    $hojita->setCellValue('E4', "Fecha Salida");
    $hojita->getStyle('E4')->getFont()->setSize(12);
    $hojita->getStyle('E4')->getFont()->setBold(true);
    $hojita->getStyle('E4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

    $hojita->setCellValue('F4', "Hora Salida");
    $hojita->getStyle('F4')->getFont()->setSize(12);
    $hojita->getStyle('F4')->getFont()->setBold(true);
    $hojita->getStyle('F4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

    $hojita->setCellValue('G4', "Foto Documento");
    $hojita->getStyle('G4')->getFont()->setSize(12);
    $hojita->getStyle('G4')->getFont()->setBold(true);
    $hojita->getStyle('G4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

    $hojita->setCellValue('H4', "Foto Firma");
    $hojita->getStyle('H4')->getFont()->setSize(12);
    $hojita->getStyle('H4')->getFont()->setBold(true);
    $hojita->getStyle('H4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    ...
    if($datos):
        ...
        foreach ($datos as $index => $item): 
            ...
            $hojita->setCellValue('A'.$i, $item['id_sys_rrhh_cedula']);
            ...
            $hojita->setCellValue('B'.$i, $item['nombres']);
            ...
            $hojita->setCellValue('C'.$i, $item['fecha_ingreso']);
            ...
            $hojita->setCellValue('D'.$i, date('H:i:s', strtotime($item['hora_ingreso'])));
            ...
            $hojita->setCellValue('E'.$i,$item['fecha_salida']);
            ...
            $hojita->setCellValue('F'.$i, date('H:i:s', strtotime($item['hora_salida'])));
            ...
            if(file_exists('C:\fotos\documentos\p'.$item['id_sys_rrhh_cedula'].'_'.$newfecha.'.png')){
                ...
                $imagendocumento->setCoordinates('G'.$i);
                $imagendocumento->setOffsetX(20);                         
                $imagendocumento->setOffsetY(10); 
                $imagendocumento->setWidth(20);
                $imagendocumento->setHeight(40);  
                $imagendocumento->setWorksheet($hojita);    
            }else{
                $hojita->getStyle('G'.$i)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $hojita->getStyle('G'.$i)->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
            ...
            if(file_exists('C:\fotos\firmas\p'.$item['id_sys_rrhh_cedula'].'_'.$newfecha.'.png')){
                ...
                $imagenfirma->setCoordinates('H'.$i);
                $imagenfirma->setOffsetX(5);                         
                $imagenfirma->setOffsetY(10); 
                $imagenfirma->setWidth(20);
                $imagenfirma->setHeight(40);  
                $imagenfirma->setWorksheet($hojita); 
            }else{
                $hojita->getStyle('H'.$i)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $hojita->getStyle('H'.$i)->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
