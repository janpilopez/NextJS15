...
?>
<table  class="table table-bordered table-condensed" style="<?= $style?>" id="table">
    <thead>
      <tr>
        <th>No.</th>
        <th>Cédula</th>
        <th>Nombres</th>
        <th>Área/Departamento Visitado</th>
        <th>Fecha Ingreso</th>
        <th>Hora Ingreso</th>
        <th>Fecha Salida</th>
        <th>Hora Salida</th>
    ...
    <tbody>
     ...
     foreach ($datos as $index => $item):
        ...
        <tr class="isres">
            <td width="5%"><?= $cont ?></td>
            <td width="10%"><?= $item['id_sys_rrhh_cedula'] ?></td>
            ...
            <td width="15%" class='abrir-modal'><img width="10%" height ='10%' src="data:image/*;base64, <?= $fotoDocumento['baze64']?>" alt=""/></td>
