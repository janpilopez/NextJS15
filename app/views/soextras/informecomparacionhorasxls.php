...
if($tipo =='R'):
    ...
    $reporte  = "Resumen Horas Generadas VS Horas Solicitadas Por Area y Departamento";

elseif($tipo == 'D'):

    $reporte  = "Detalle Horas Generadas VS Horas Solicitadas Por Empleados";  
    ...
    <div class="col-xs-12">
      ...
      <?php 
        ...
        if($tipo == 'R'):
            ...
            echo $this->render('_tablecomparacionxls', ['datos'=> $datos,'fechaini'=> $fechaini,'fechafin'=>$fechafin,'IDarea'=>$area,'IDdepartamento'=>$departamento]);
  
        elseif($tipo == 'D'):
  
            echo $this->render('_tablecomparaciondetallexls', ['datos'=> $datos, 'fechaini'=> $fechaini, 'fechafin'=> $fechafin, 'IDarea'=>$area,'IDdepartamento'=>$departamento]);
