...
<table  class="table table-bordered table-condensed">
    ...
    <?php 
      ...
      $dataFilterIdSysAdmArea =  array_unique(array_map(array(new FilterColumn("departamento"), 'getValues'), $datosSolicitud));  
      $con = 0;
      foreach ($dataFilterIdSysAdmArea as $index => $departamento):  
        $con+=1;
        $area = '';
        $arrayData   = array_filter($datosSolicitud, array(new FilterData("departamento", $departamento), 'getFilter'));
        $horas = '';
        $horasDecimal  = 0;
        $h25 = 0;
        $h50 = 0;
        ...
        foreach ($datosSolicitud as $index  => $data):
