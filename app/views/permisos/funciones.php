...
function gethoras50($entrada,$salida, $cedula, $fecha){
 ...
 function restarMinutosLunch ($totalhoras){
     
    $fechaUno=new DateTime('00:30');
...
function gethoras100($entrada, $salida, $cedula, $fecha, $feriado, $agendamiento){
        
    $horatrabas      =  date('Y-m-d', strtotime($entrada)).' '.getTotalhoras($entrada, $salida); //horas trabajadas
    $horanormal      =  date('Y-m-d', strtotime($entrada)).' '."08:30:00"; //horas normal
    $hsalida         =  getSalidaLaboral($entrada, $salida, $horanormal);
    $dia             =  date("N", strtotime($fecha));
    ...
    $diaLibre = getDiaLibre($cedula, $fecha);
        ...
        elseif($diaLibre):
            ...
            if($dia == 6  || $dia == 7):
                ...
                if($lunchs):
                    return restarMinutosLunch(getTotalhoras($entrada, $salida));
                else:
                    return getTotalhoras($entrada, $salida);
                endif;
        ...
        elseif($dia == 6  || $dia == 7):
            ...
            if($agendamiento):
                ...
                if($lunchs):
                    return restarMinutosLunch(getTotalhoras($horanormal, $horatrabas));
                else:
                    return getTotalhoras($horanormal, $horatrabas);
                endif;
