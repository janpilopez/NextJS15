...
/* @var $model app\models\SysRrhhEmpleadosUniformes */
...
?>
<div class="sys-rrhh-empleados-uniforme-form">
                     ...
                     <div class='col-md-2'> 
                      ...
                      <div class = 'panel panel-default'>  
                        <div class = 'panel-body'>
                            ...
                            <img width="20%" height ='20%' src="data:fotos/uniformes/jpeg;base64, <?= $fotos?>" alt="" />
        ...
        <div class = 'row'>
          <div class= 'col-md-12'>
              <div class="form-group text-center">
                    ...
                    <?= Html::submitButton('Guardar Datos', ['class' => 'btn btn-success' , 'disabled' => $inputDisable]) ?>
              </div>  
          </div>
       </div>
      </div>
