...
$this->title = 'Impresión de  Rol Pago Usuario Personal';
...
@media print{
   ...
   <h1  class ='no-print'><?= Html::encode($this->title)?></h1>
       ...
       <div class= 'col-md-2'>
            <input type="hidden" class="form-control input-sm" value = "<?php echo Yii::$app->user->identity->cedula?>" name = 'cedula'  readonly>
       </div>
