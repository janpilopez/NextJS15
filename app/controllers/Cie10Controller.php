...
use app\models\search\SysMedCie10Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Cie10Controller implements the CRUD actions for SysMedCie10 model.
 */
class Cie10Controller extends Controller
{
    ...
    /**
     * Lists all SysMedCie10 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SysMedCie10Search();
    ...
    /**
     * Displays a single SysMedCie10 model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new SysMedCie10 model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new SysMedCie10();
    ...
    /**
     * Updates an existing SysMedCie10 model.
    ...
    /**
     * Deletes an existing SysMedCie10 model.
    ...
    /**
     * Finds the SysMedCie10 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SysMedCie10 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SysMedCie10::findOne($id)) !== null) {
            return $model;
        }
